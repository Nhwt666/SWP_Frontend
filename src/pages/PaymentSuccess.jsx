            ...
            {method === 'momo' && (
                <>
                    <div style={{
                        display: 'inline-block',
                        padding: '10px 20px',
                        backgroundColor: status === 'SUCCESS' ? '#d4edda' : (status === 'FAILED' ? '#f8d7da' : '#fff3cd'),
                        color: status === 'SUCCESS' ? '#155724' : (status === 'FAILED' ? '#721c24' : '#856404'),
                        border: '1px solid',
                        borderColor: status === 'SUCCESS' ? '#c3e6cb' : (status === 'FAILED' ? '#f5c6cb' : '#ffeeba'),
                        borderRadius: '5px',
                        minWidth: 300
                    }}>
                        {message}
